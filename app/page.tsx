...
/* Hero carousel images – you can swap these with any galaxy/nature images you like */
const HERO_IMAGES = [
...
function HeroCarousel() {
  ...
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden">
      ...
      {/* Slight radial spotlight so the center is readable but edges stay moody */}
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,0,0,0.25)_0%,rgba(0,0,0,0.65)_55%,rgba(0,0,0,0.9)_100%)]" />
    </div>
  );
}
      ...
      <section className="relative isolate flex min-h-[80vh] items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-full max-w-screen-2xl px-6 sm:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            {/* Supporting line tight to headline */}
            ...
            {/* CTA centered visually between the text blocks */}
            <div className="mt-7 flex justify-center">
              <a
                href="/contact"
                className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-emerald-400 to-emerald-300 px-12 py-4 text-[16px] font-semibold text-black shadow-[0_18px_45px_rgba(16,185,129,0.55)] transition hover:from-emerald-300 hover:to-emerald-200 hover:shadow-[0_16px_40px_rgba(16,185,129,0.65)]"
              >
            ...
            {/* Trust copy just under CTA */}
            <p className="mt-5 text-[11px] uppercase tracking-[0.18em] text-zinc-200/90">
