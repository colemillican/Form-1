...
/* Hero carousel images (minimal tech abstract) */
const HERO_IMAGES = [
  ...
  "https://images.unsplash.com/photo-1528493366314-e317cd98dd6b?q=80&w=2000&auto=format&fit=crop",
];
    ...
    <div className="absolute inset-0 -z-10 overflow-hidden">
      {HERO_IMAGES.map((src, i) => (
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(3,7,18,0.70), rgba(3,7,18,0.70)), url(${src})`,
  ...
  return (
    <SiteChrome>
      ...
      <section className="relative isolate flex min-h-[86vh] items-center justify-center overflow-hidden">
        <HeroCarousel />
        {/* Soft glow accents */}
        <div className="pointer-events-none absolute -top-24 -left-24 h-[50vh] w-[50vh] rounded-full bg-emerald-500/18 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-40 -right-40 h-[55vh] w-[55vh] rounded-full bg-sky-500/14 blur-3xl" />
